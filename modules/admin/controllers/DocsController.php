...
class DocsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->doc->saveAs('uploads/pdf/' . time() . '.' . $model->doc->extension);
            $model->doc = '/uploads/pdf/'. time() . '.' . $model->doc->extension;
            $model->save();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(file_exists(Yii::$app->basePath.$model->getOldAttribute('doc'))){
                unlink(Yii::$app->basePath.$model->getOldAttribute('doc'));
            }
